...
import { ITitleDataEnemies, IPlanetData, TITLE_DATA_PLANETS, ITitleDataPlanets, IStringDictionary, TITLE_DATA_ENEMIES } from "../shared/types";
...
export const actionSetEnemiesFromTitleData = (data: IStringDictionary) => {
    const enemyData = JSON.parse(data[TITLE_DATA_ENEMIES]) as ITitleDataEnemies;
