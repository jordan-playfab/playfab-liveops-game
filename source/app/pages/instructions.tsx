...
const UlImages = styled.ul`
    margin: ${s => s.theme.size.spacer} 0 0 ${s => s.theme.size.spacer2};
    padding: 0;
    list-style: none;
            ...
            <Page {...this.props} title="Instructions">
                ...
                <OlInstructions>
                    <li>
                        ...
                        <p>If you already have a PlayFab account, <a href="https://developer.playfab.com/en-US/login" target="_blank">log in</a> and create an empty title on your studio.</p>
                        <UlImages>
                    ...
                    <li>
                        ...
                        <p>It appears below the name on the My Studios and Titles page, as well as the browser's address bar.</p>
                        <UlImages>
                    ...
                    <li>
                        ...
                        <p>The battles get harder on planets further to the right. Choose <strong>Earth</strong> for a safe start.</p>
                        <UlImages>
                    ...
                    <li>
                        <h3>More ideas</h3>
                        <p><Link to={routes.Index("")}>Enter a title ID</Link> and see our Tips page for ideas on how to modify your title and see those changes reflected in the game.</p>
