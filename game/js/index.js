...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst React = __webpack_require__(/*! react */ \"./node_modules/react/index.js\");\nconst router_1 = __webpack_require__(/*! ./router */ \"./source/app/router.tsx\");\nclass App extends React.Component {\n    constructor() {\n        super(undefined);\n        this.saveTitleID = (titleID) => {\n            this.setState({\n                titleID,\n            });\n        };\n        this.savePlayer = (player) => {\n            this.setState({\n                player,\n            });\n        };\n        this.state = {\n            titleID: null,\n            player: null,\n        };\n    }\n    render() {\n        return (React.createElement(router_1.Router, { titleID: this.state.titleID, saveTitleID: this.saveTitleID, player: this.state.player, savePlayer: this.savePlayer }));\n    }\n}\nexports.default = App;\n\n\n//# sourceURL=webpack:///./source/app/app.tsx?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst React = __webpack_require__(/*! react */ \"./node_modules/react/index.js\");\nconst TextField_1 = __webpack_require__(/*! office-ui-fabric-react/lib/TextField */ \"./node_modules/office-ui-fabric-react/lib/TextField.js\");\nconst office_ui_fabric_react_1 = __webpack_require__(/*! office-ui-fabric-react */ \"./node_modules/office-ui-fabric-react/lib/index.js\");\nconst is_1 = __webpack_require__(/*! ../shared/is */ \"./source/app/shared/is.ts\");\nconst react_router_1 = __webpack_require__(/*! react-router */ \"./node_modules/react-router/esm/react-router.js\");\nconst routes_1 = __webpack_require__(/*! ../routes */ \"./source/app/routes.ts\");\nconst playfab_1 = __webpack_require__(/*! ../shared/playfab */ \"./source/app/shared/playfab.ts\");\nclass Player extends React.Component {\n    constructor(props) {\n        super(props);\n        this.setLocalPlayerID = (_, newValue) => {\n            this.setState({\n                playerID: newValue,\n            });\n        };\n        this.login = () => {\n            this.setState({\n                error: null,\n            });\n            playfab_1.PlayFab.login(this.props, this.state.playerID, (player) => {\n                this.props.savePlayer(player);\n            }, (message) => {\n                this.setState({\n                    error: message,\n                });\n            });\n        };\n        this.state = {\n            playerID: null,\n            error: null\n        };\n    }\n    render() {\n        if (is_1.is.null(this.props.titleID)) {\n            return React.createElement(react_router_1.Redirect, { to: routes_1.routes.Home });\n        }\n        return (React.createElement(React.Fragment, null,\n            React.createElement(\"h1\", null, \"Player\"),\n            React.createElement(\"p\", null,\n                \"Your title ID is \",\n                this.props.titleID),\n            !is_1.is.null(this.state.error) && (React.createElement(\"p\", null,\n                \"There was an error: \",\n                this.state.error)),\n            React.createElement(\"p\", null, \"Start by entering a player ID. This can be a name (e.g. \\\"James\\\"), a GUID, or any other string.\"),\n            React.createElement(\"p\", null, \"Enter a new player ID to start a new game, or a previous one to load that player's data.\"),\n            React.createElement(\"p\", null, \"This page will let you login a player using Custom ID.\"),\n            is_1.is.null(this.props.player)\n                ? this.renderPlayerLogin()\n                : this.renderPlayer()));\n    }\n    renderPlayerLogin() {\n        return (React.createElement(\"form\", null,\n            React.createElement(\"fieldset\", null,\n                React.createElement(\"legend\", null, \"Player\"),\n                React.createElement(TextField_1.TextField, { label: \"Player ID\", onChange: this.setLocalPlayerID }),\n                React.createElement(office_ui_fabric_react_1.PrimaryButton, { text: \"Save\", onClick: this.login }))));\n    }\n    renderPlayer() {\n        return (React.createElement(React.Fragment, null,\n            React.createElement(\"p\", null,\n                React.createElement(\"strong\", null, \"You are logged in as:\"),\n                \" \",\n                this.props.player.PlayFabId),\n            React.createElement(\"p\", null, \"Continue to the Tower (coming soon)\")));\n    }\n}\nexports.default = Player;\n\n\n//# sourceURL=webpack:///./source/app/pages/player.tsx?");
